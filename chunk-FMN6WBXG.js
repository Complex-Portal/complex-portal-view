import{a as q}from"./chunk-2KXQA66R.js";import{a as $}from"./chunk-VDNG76UK.js";import{o as W}from"./chunk-YMCJUFMT.js";import{D as U,h as G}from"./chunk-7Q6ZDWGY.js";import{Aa as c,Ba as m,Cb as P,Ea as M,ea as d,ga as H,h as o,nb as F,p as z,t as j,ya as p}from"./chunk-TSD2EAZW.js";var X=`<div class="ComplexNavigator">
...
`;var K="";var _e=function(a,e,t,i){var r=arguments.length,n=r<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(a,e,t,i);else for(var l=a.length-1;l>=0;l--)(s=a[l])&&(n=(r<3?s(n):r>3?s(e,t,n):s(e,t))||n);return r>3&&n&&Object.defineProperty(e,t,n),n},O,u=(O=class{constructor(){o(this,"complexSearch");o(this,"interactors");o(this,"canAddComplexesToBasket");o(this,"canRemoveComplexesFromBasket");o(this,"onComplexRemovedFromBasket",H());o(this,"interactorsSorting","Occurrence");o(this,"organismIconDisplay",!0);o(this,"interactorTypeDisplay",!0);o(this,"IDDisplay",!0)}},o(O,"propDecorators",{complexSearch:[{type:c}],interactors:[{type:c}],canAddComplexesToBasket:[{type:c}],canRemoveComplexesFromBasket:[{type:c}],onComplexRemovedFromBasket:[{type:m}]}),O);u=_e([p({selector:"cp-complex-navigator",template:X,styles:[K]})],u);var J=`<div class="complexNavigatorTable">
  <div class="header"
...
`;var Oe=function(a,e,t,i){var r=arguments.length,n=r<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(a,e,t,i);else for(var l=a.length-1;l>=0;l--)(s=a[l])&&(n=(r<3?s(n):r>3?s(e,t,n):s(e,t))||n);return r>3&&n&&Object.defineProperty(e,t,n),n},L,y=(L=class{constructor(){o(this,"complexSearch");o(this,"interactors");o(this,"interactorsSorting");o(this,"organismIconDisplay");o(this,"interactorTypeDisplay");o(this,"IDDisplay");o(this,"canAddComplexesToBasket");o(this,"canRemoveComplexesFromBasket");o(this,"onComplexRemovedFromBasket",new d);o(this,"sortedComplexes",[])}ngOnChanges(){this.sortedComplexes=this.classifyComplexesSimilaritiesV2(this.complexSearch.elements)}getComponentAsComplex(e){return this.complexSearch.elements.find(t=>t.complexAC===e.identifier)}getAllComponents(e,t=[]){for(let i of e.interactors)if(i.interactorType==="stable complex"){let r=this.getComponentAsComplex(i);r?t.push(...this.getAllComponents(r)):t.push(i)}else t.push(i);return t}calculateSimilarity(e,t){if(e===t)return new Set(this.getAllComponents(e)).size;let[i,r]=[e,t].map(n=>new Set(this.getAllComponents(n).map(s=>s.identifier)));return[...i.values()].reduce((n,s)=>r.has(s)?n+1:n,0)}classifyComplexesSimilaritiesV2(e){let t=[];for(let r of e)for(let n of e)r.complexAC>=n.complexAC&&t.push([r,n,this.calculateSimilarity(r,n)]);t.sort((r,n)=>n[2]-r[2]);let i=this.uniqueComplexesListOrderedBySimilarity(t);return Array.from(i)}uniqueComplexesListOrderedBySimilarity(e){let t=new Set;for(let i=0;i<e.length;i++){let[r,n,s]=e[i];if(s!==0){t.add(r),t.add(n);for(let l=i+1;l<e.length;l++){let[Ce,be,ve]=e[l];r===Ce&&ve!==0&&t.add(be)}if(t.size===this.complexSearch.elements.length)return t}if(t.size===this.complexSearch.elements.length)return t}return t}},o(L,"propDecorators",{complexSearch:[{type:c}],interactors:[{type:c}],interactorsSorting:[{type:c}],organismIconDisplay:[{type:c}],interactorTypeDisplay:[{type:c}],IDDisplay:[{type:c}],canAddComplexesToBasket:[{type:c}],canRemoveComplexesFromBasket:[{type:c}],onComplexRemovedFromBasket:[{type:m}]}),L);y=Oe([p({selector:"cp-table-structure",template:J,styles:[Q]})],y);var Y=`<div class="Complex-navigator">
...
`;function ee(a){switch(a){case"small molecule":return"icon icon-conceptual icon-chemical";case"protein":case"peptide":return"icon icon-conceptual icon-structures-3d";case"stable complex":return"icon icon-conceptual icon-systems";case"molecule set":return"icon icon-generic icon-math";case"single stranded deoxyribonucleic acid":case"double stranded deoxyribonucleic acid":case"small nuclear rna":case"small nucleolar rna":case"ribosomal rna":case"messenger rna":case"transfer rna":case"signal recognition particle rna":case"ribonucleic acid":case"nucleic acid":case"long non-coding ribonucleic acid":return"icon icon-conceptual icon-dna"}}function g(a){switch(ke(a)){case"Homo sapiens":return"icon icon-species icon-human";case"Mus musculus":return"icon icon-species icon-mouse";case"Schizosaccharomyces pombe":case"Saccharomyces cerevisiae":return"icon icon-species icon-yeast";case"Escherichia coli":case"Pseudomonas aeruginosa":case"Klebsiella pneumoniae":case"Chlamydomonas reinhardtii":return"icon icon-species icon-ecoli";case"Rattus norvegicus":return"icon icon-species icon-rat";case"Caenorhabditis elegans":return"icon icon-species icon-c-elegans";case"Gallus gallus":return"icon icon-species icon-chicken";case"Drosophila melanogaster":return"icon icon-species icon-fly";case"Bos taurus":return"icon icon-species icon-cow";case"Oryctolagus cuniculus":return"icon icon-species icon-rabbit";case"Ovis aries":return"icon icon-species icon-sheep";case"Xenopus laevis":return"icon icon-species icon-frog";case"Canis lupus":case"Canis familiaris":return"icon icon-species icon-dog";case"Vibrio cholerae":return"assets/images/EMBL_Species_Vibrio_cholerae.svg";case"Crotalus durissus":return"assets/images/EMBL_Species_RattleSnake.svg";case"Sus scrofa":return"icon icon-species icon-pig";case"Torpedo marmorata":case"Tetronarce californica":return"icon icon-species icon-ray";case"Lymnaea stagnalis":return"icon icon-species icon-snail";case"Arabidopsis thaliana":return"icon icon-species icon-brassica";case"Danio rerio":return"icon icon-species icon-zebrafish";case"Severe acute":case"Human SARS":case"SARS-CoV-2":case"Middle East":case"Human betacoronavirus":return"icon icon-species icon-virus"}return""}function ke(a){return(a||"?").split(";")[0].split(" ").slice(0,2).join(" ")}var Ne=function(a,e,t,i){var r=arguments.length,n=r<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(a,e,t,i);else for(var l=a.length-1;l>=0;l--)(s=a[l])&&(n=(r<3?s(n):r>3?s(e,t,n):s(e,t))||n);return r>3&&n&&Object.defineProperty(e,t,n),n},x,I=(x=class{constructor(e){o(this,"basketService");o(this,"complexes");o(this,"interactorsSorting");o(this,"canAddComplexesToBasket");o(this,"canRemoveComplexesFromBasket");o(this,"onComplexRemovedFromBasket",new d);this.basketService=e}isInteractorSortingSet(){return this.interactorsSorting==="Type"||this.interactorsSorting==="Organism"}iconOrganism(e){return g(e)}toggleBasket(e){this.isInBasket(e.complexAC)?this.removeComplex(e.complexAC):this.saveComplex(e)}saveComplex(e){this.basketService.saveInBasket(e)}removeComplex(e){this.basketService.deleteFromBasket(e),this.onComplexRemovedFromBasket.emit(e)}isInBasket(e){return this.basketService.isInBasket(e)}},o(x,"ctorParameters",()=>[{type:W}]),o(x,"propDecorators",{complexes:[{type:c}],interactorsSorting:[{type:c}],canAddComplexesToBasket:[{type:c}],canRemoveComplexesFromBasket:[{type:c}],onComplexRemovedFromBasket:[{type:m}]}),x);I=Ne([p({selector:"cp-table-header",template:Y,styles:[Z]})],I);var te=`<div class="Complex-navigator">
...
`;var We=function(a,e,t,i){var r=arguments.length,n=r<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(a,e,t,i);else for(var l=a.length-1;l>=0;l--)(s=a[l])&&(n=(r<3?s(n):r>3?s(e,t,n):s(e,t))||n);return r>3&&n&&Object.defineProperty(e,t,n),n},R,v=(R=class{constructor(){o(this,"interactorName");o(this,"interactorType");o(this,"interactorId");o(this,"interactorOrganism");o(this,"identifierLink");o(this,"organismIconDisplay");o(this,"interactorTypeDisplay");o(this,"IDDisplay");o(this,"isMainInteractor");o(this,"interactorTypeIcon");o(this,"interactorOrganismIcon");o(this,"externalLinkVisible")}ngOnInit(){this.interactorTypeIcon=ee(this.interactorType),this.interactorOrganismIcon=g(this.interactorOrganism)}externalLinkVisibleHandler(e){this.externalLinkVisible=e}},o(R,"propDecorators",{interactorName:[{type:c}],interactorType:[{type:c}],interactorId:[{type:c}],interactorOrganism:[{type:c}],identifierLink:[{type:c}],organismIconDisplay:[{type:c}],interactorTypeDisplay:[{type:c}],IDDisplay:[{type:c}],isMainInteractor:[{type:c}]}),R);v=We([p({selector:"cp-table-interactor-name",template:re,styles:[oe]})],v);var ae=`<div class="externalLinkContainer" [matTooltip]="'More information about ' + interactorId">
...
`;var Ke=function(a,e,t,i){var r=arguments.length,n=r<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(a,e,t,i);else for(var l=a.length-1;l>=0;l--)(s=a[l])&&(n=(r<3?s(n):r>3?s(e,t,n):s(e,t))||n);return r>3&&n&&Object.defineProperty(e,t,n),n},N,D=(N=class{constructor(){o(this,"stoichiometryText");o(this,"stoichiometryValue")}},o(N,"propDecorators",{stoichiometryText:[{type:c}],stoichiometryValue:[{type:c}]}),N);D=Ke([p({selector:"cp-table-interactor-stoichiometry",template:ce,styles:[le]})],D);var pe=`<div [ngClass]="topLineClass"></div>
...
`;var rt=function(a,e,t,i){var r=arguments.length,n=r<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(a,e,t,i);else for(var l=a.length-1;l>=0;l--)(s=a[l])&&(n=(r<3?s(n):r>3?s(e,t,n):s(e,t))||n);return r>3&&n&&Object.defineProperty(e,t,n),n},V,w=(V=class{constructor(){o(this,"interactorsSortingChange",new d);o(this,"organismIconDisplayChange",new d);o(this,"interactorTypeDisplayChange",new d);o(this,"IDDisplayChange",new d);o(this,"interactorsSorting");o(this,"organismIconDisplay");o(this,"interactorTypeDisplay");o(this,"IDDisplay");o(this,"typeOfDisplay")}ngOnInit(){this.updateDisplay()}interactorsSortingChanges(e){this.interactorsSortingChange.emit(e),this.typeOfDisplay==="detailed"&&(e==="Type"?(this.interactorTypeDisplay=!1,this.organismIconDisplay=!0):e==="Organism"&&(this.organismIconDisplay=!1,this.interactorTypeDisplay=!0),this.updateDisplay())}DisplayingOrganism(){this.organismIconDisplay=!this.organismIconDisplay,this.updateDisplay()}DisplayingType(){this.interactorTypeDisplay=!this.interactorTypeDisplay,this.updateDisplay()}DisplayingID(){this.IDDisplay=!this.IDDisplay,this.updateDisplay()}setDisplayType(e){e==="compact"?this.compactDisplay():e==="detailed"&&this.detailedDisplay()}compactDisplay(){this.organismIconDisplay=!1,this.interactorTypeDisplay=!1,this.IDDisplay=!1,this.typeOfDisplay="compact",this.changesEmitter()}detailedDisplay(){this.organismIconDisplay=!0,this.interactorTypeDisplay=!0,this.IDDisplay=!0,this.typeOfDisplay="detailed",this.changesEmitter()}updateDisplay(){this.organismIconDisplay||this.interactorTypeDisplay||this.IDDisplay?this.typeOfDisplay="detailed":this.typeOfDisplay="compact",this.changesEmitter()}changesEmitter(){this.organismIconDisplayChange.emit(this.organismIconDisplay),this.interactorTypeDisplayChange.emit(this.interactorTypeDisplay),this.IDDisplayChange.emit(this.IDDisplay)}},o(V,"propDecorators",{interactorsSortingChange:[{type:m}],organismIconDisplayChange:[{type:m}],interactorTypeDisplayChange:[{type:m}],IDDisplayChange:[{type:m}],interactorsSorting:[{type:c}],organismIconDisplay:[{type:c}],interactorTypeDisplay:[{type:c}],IDDisplay:[{type:c}]}),V);w=rt([p({selector:"cp-complex-navigator-buttons",template:ue,styles:[fe]})],w);var ye=`<div class="displayButton columns medium-12" [ngClass]="">
...
`;var ge=`.displayButton{text-align:center}.view-button{width:225px;margin-right:5px;background-color:#fff;color:#555;border:1px dotted var(--primary)}.view-button:hover{color:var(--primary);background-color:#eaeaea;border:transparent;border-bottom:1px dotted var(--primary)}.selected,.selected:hover{background-color:var(--primary);color:#fff}.new-tag{color:red;font-weight:700;font-size:x-small}.new-tag-selected{color:#ff0}.cnButton{outline-offset:0;outline:rgba(0,124,130,.75) solid 1px;animation:animateOutline 4s ease infinite}.cnButton.selected{animation:none}@keyframes animateOutline{0%,50%,to{outline-width:6px;outline-offset:4px;outline-color:#007c8200}10%{outline-color:#007c82bf}}
`;var st=function(a,e,t,i){var r=arguments.length,n=r<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(a,e,t,i);else for(var l=a.length-1;l>=0;l--)(s=a[l])&&(n=(r<3?s(n):r>3?s(e,t,n):s(e,t))||n);return r>3&&n&&Object.defineProperty(e,t,n),n},ct="view_list",xe="view_complex_navigator",A,f=(A=class{constructor(){o(this,"displayType");o(this,"displayTypeChange",new d)}setListView(){this.displayType=ct,this.displayTypeChange.emit(this.displayType)}setComplexNavigatorView(){this.displayType=xe,this.displayTypeChange.emit(this.displayType)}isDisplayComplexNavigatorView(){return this.displayType===xe}},o(A,"propDecorators",{displayType:[{type:c}],displayTypeChange:[{type:m}]}),A);f=st([p({selector:"cp-complex-list-display-buttons",template:ye,styles:[ge]})],f);var lt=function(a,e,t,i){var r=arguments.length,n=r<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(a,e,t,i);else for(var l=a.length-1;l>=0;l--)(s=a[l])&&(n=(r<3?s(n):r>3?s(e,t,n):s(e,t))||n);return r>3&&n&&Object.defineProperty(e,t,n),n},Ie=class{};Ie=lt([M({imports:[P,F,U,q,$],exports:[u,f],declarations:[u,y,I,b,v,S,D,_,T,w,f]})],Ie);export{ct as a,xe as b,ee as c,g as d,Ie as e};
