...
let ComplexFilterComponent = class ComplexFilterComponent {
    ...
    changeEvidenceTypeFilter(filter, status) {
        if (status) {
...
let ComplexResultsComponent = class ComplexResultsComponent {
    ...
    requestComplexResults() {
        this.complexPortalService.findComplex(this.query, this.spicesFilter, this.bioRoleFilter, this.interactorTypeFilter, this.predictedFilter, this.evidenceTypeFilter, this.currentPageIndex, this.pageSize).subscribe(complexSearch => {
...
module.exports = ".description {\n  width: 90%;\n  text-align: justify;\n}\n\n.container {\n  display: inline-flex;\n  width: -webkit-fill-available;\n}\n\n.complexesAndDescription {\n  padding: 10px;\n  width: 95%;\n}\n\n.basketButtonContainer {\n  width: -moz-fit-content;\n  width: fit-content;\n  height: -moz-fit-content;\n  height: fit-content;\n  margin-top: 10px;\n}\n\n.basket-icons {\n  margin-left: 5px;\n}\n\n.predictedOrCuratedLabel {\n  background-color: var(--primary);\n  color: var(--on-primary);\n  padding: 4px 8px;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */";
