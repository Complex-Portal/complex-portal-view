(function () {
  ...
  (self["webpackChunkcomplex_portal_view"] = self["webpackChunkcomplex_portal_view"] || []).push([["default-node_modules_angular_material___ivy_ngcc___fesm2015_tooltip_js"], {
    /***/
    62604:
    /*!************************************************************************!*\
          ...
          value: function enable() {
            ...
            if (!this._scrollSubscription) {
              ...
              this._scrollSubscription = this._scrollDispatcher.scrolled(throttle).subscribe(function () {
                _this13._overlayRef.updatePosition(); // TODO(crisbeto): make `close` on by default once all components can handle it.
                ...
                if (_this13._config && _this13._config.autoClose) {
                  ...
                  var _this13$_viewportRule = _this13._viewportRuler.getViewportSize(),
                      ...
                      height = _this13$_viewportRule.height; // TODO(crisbeto): include all ancestor scroll containers here once
      ...
      var _OverlayOutsideClickDispatcher = /*#__PURE__*/function (_BaseOverlayDispatche2) {
        ...
        function _OverlayOutsideClickDispatcher(document, _platform) {
          ...
          _this16._clickListener = function (event) {
            ...
            var origin = event.type === 'click' && _this16._pointerDownEventTarget ? _this16._pointerDownEventTarget : target; // Reset the stored pointerdown event target, to avoid having it interfere
            // in subsequent events.

            _this16._pointerDownEventTarget = null; // We copy the array because the original may be modified asynchronously if the
            // outsidePointerEvents listener decides to detach overlays resulting in index errors inside
            // the for loop.

            var overlays = _this16._attachedOverlays.slice(); // Dispatch the mouse event to the top overlay which has subscribers to its mouse events.
        ...
        function _ViewportRuler(_platform, ngZone, document) {
          ...
          ngZone.runOutsideAngular(function () {
            if (_platform.isBrowser) {
              var _window = _this43._getWindow(); // Note that bind the events ourselves, rather than going through something like RxJS's
          ...
          value: function ngOnInit() {
            ...
            this.ngZone.runOutsideAngular(function () {
              return Promise.resolve().then(function () {
                ...
                _this45.elementScrolled().pipe( // Start off with a fake scroll event so we properly detect our initial position.
        ...
        _createClass(_TooltipComponentBase2, [{
          ...
          value: function show(delay) {
            ...
            this._showTimeoutId = setTimeout(function () {
              ...
              _this65._onShow(); // Mark for check so if any parent component has set the
          ...
          value: function hide(delay) {
            ...
            this._hideTimeoutId = setTimeout(function () {
              ...
              _this66._hideTimeoutId = undefined; // Mark for check so if any parent component has set the
              // ChangeDetectionStrategy to OnPush it will be checked anyways
...
//# sourceMappingURL=default-node_modules_angular_material___ivy_ngcc___fesm2015_tooltip_js-es5.js.map