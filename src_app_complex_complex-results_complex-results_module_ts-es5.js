    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _ComplexFilterComponent = /*#__PURE__*/function () {
        function ComplexFilterComponent(googleAnalyticsService) {
          ...
          this.onConfidenceScoreFilterChanged = new _angular_core__WEBPACK_IMPORTED_MODULE_4__.EventEmitter();
        ...
        _createClass(ComplexFilterComponent, [{
          ...
          key: "changeConfidenceScoreFilter",
          value: function changeConfidenceScoreFilter(filter, status) {
            if (status) {
          ...
          key: "_getStars",
          value: function _getStars(amount) {
      ...
      _ComplexFilterComponent.propDecorators = {
        ...
        onConfidenceScoreFilterChanged: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_4__.Output
        }],
        onResetAllFilters: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_4__.Output
      ...
      var _ComplexResultsComponent = /*#__PURE__*/function () {
        ...
        _createClass(ComplexResultsComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.route.fragment.subscribe(function (fragment) {
              ...
              _this2.route.queryParams.subscribe(function (queryParams) {
                ...
                Object.keys(_this2.filters).forEach(function (filter) {
                  return _this2.filters[filter] = _this2.decodeURL(filter, queryParams);
                });
          ...
          value: function requestComplexResults() {
            var _this3 = this;
            this.complexPortalService.findComplex(this.query, this.filters.species, this.filters.bioRole, this.filters.interactorType, this.filters.predicted, this.filters.confidenceScore, this.currentPageIndex, this.pageSize).subscribe(function (complexSearch) {
          ...
          value: function reloadPage() {
            ...
            Object.keys(this.filters).forEach(function (filter) {
              return _this4.encodeURL(_this4.filters[filter], filter, queryParams);
            });
          ...
          key: "onConfidenceScoreFilterChanged",
          value: function onConfidenceScoreFilterChanged(filter) {
