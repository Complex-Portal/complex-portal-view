(function () {
  ...
  (self["webpackChunkcomplex_portal_view"] = self["webpackChunkcomplex_portal_view"] || []).push([["src_app_complex_complex-results_complex-results_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */
      var _angular_platform_browser__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__( /*! @angular/platform-browser */71570);
      /* harmony import */
      ...
      /* harmony import */
      var _complex_navigator_complex_list_display_buttons_complex_list_display_buttons_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__( /*! ./complex-navigator/complex-list-display-buttons/complex-list-display-buttons.component */99915);
      var __decorate = undefined && undefined.__decorate || function (decorators, target, key, desc) {
        var c = arguments.length,
          r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc,
          d;
        ...
        _createClass(ComplexResultsComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.route.fragment.subscribe(function (fragment) {
              if (fragment === _complex_navigator_complex_list_display_buttons_complex_list_display_buttons_component__WEBPACK_IMPORTED_MODULE_7__.COMPLEX_NAVIGATOR_VIEW) {
                _this2.DisplayType = _complex_navigator_complex_list_display_buttons_complex_list_display_buttons_component__WEBPACK_IMPORTED_MODULE_7__.COMPLEX_NAVIGATOR_VIEW;
              } else if (fragment === _complex_navigator_complex_list_display_buttons_complex_list_display_buttons_component__WEBPACK_IMPORTED_MODULE_7__.LIST_VIEW) {
                _this2.DisplayType = _complex_navigator_complex_list_display_buttons_complex_list_display_buttons_component__WEBPACK_IMPORTED_MODULE_7__.LIST_VIEW;
              }
          ...
          key: "currentPageIndex",
          get: function get() {
            if (this.DisplayType === _complex_navigator_complex_list_display_buttons_complex_list_display_buttons_component__WEBPACK_IMPORTED_MODULE_7__.COMPLEX_NAVIGATOR_VIEW) {
          ...
          value: function onDisplayTypeChange(displayType) {
            if (this.DisplayType !== displayType) {
              ...
              if (displayType === _complex_navigator_complex_list_display_buttons_complex_list_display_buttons_component__WEBPACK_IMPORTED_MODULE_7__.LIST_VIEW) {
                this.setListView();
              } else if (displayType === _complex_navigator_complex_list_display_buttons_complex_list_display_buttons_component__WEBPACK_IMPORTED_MODULE_7__.COMPLEX_NAVIGATOR_VIEW) {
          ...
          value: function isDisplayComplexNavigatorView() {
            return this.DisplayType === _complex_navigator_complex_list_display_buttons_complex_list_display_buttons_component__WEBPACK_IMPORTED_MODULE_7__.COMPLEX_NAVIGATOR_VIEW;
          }
        }, {
          key: "setListView",
      ...
      _ComplexResultsComponent = __decorate([(0, _angular_core__WEBPACK_IMPORTED_MODULE_10__.Component)({
    ...
    /***/
    function _(module) {
      module.exports = ".description {\n  width: 100%;\n  text-align: justify;\n}\n\n.container {\n  display: inline-flex;\n}\n\n/*.basketButton {*/\n\n/*  padding-top: 10px;*/\n\n/*}*/\n\n.complexesAndDescription {\n  padding: 10px\n}\n\n.hidden {\n  display: none;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */";
    ...
    /***/
    function _(module) {
      module.exports = ".filterColumn {\n  width: 15vw;\n}\n\n.leftAligned {\n  --global-margin: calc((100vw - 80rem) / -2);\n  --min-margin-left: calc(-100rem * 0.3);\n  margin-left: max(var(--global-margin), var(--min-margin-left));\n}\n\n.smallCN {\n  width: 55vw !important;\n}\n\n.largeCN {\n  width: 67vw !important;\n}\n\n.ComplexNavigator {\n  float: left;\n  margin-right: -2vw;\n  margin-left: auto;\n}\n\n.paginator {\n  float: left;\n  width: 75vw;\n  margin-right: -2vw;\n}\n\n.column:last-child:not(:first-child),\n.columns:last-child:not(:first-child) {\n  float: left !important;\n}\n\n.listOfResults {\n  width: 40vw;\n  margin-left: 17vw;\n  text-justify: distribute;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */";
