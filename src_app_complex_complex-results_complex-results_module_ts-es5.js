      ...
      var _ComplexFilterComponent = /*#__PURE__*/function () {
        ...
        _createClass(ComplexFilterComponent, [{
          ...
          value: function anyFiltersSelected() {
            return this.speciesFilter.length !== 0 || this.bioRoleFilter.length !== 0 || this.interactorTypeFilter.length !== 0 || this.predictedFilter.length !== 0 || this.starsFilter.length !== 0;
          }
          /**
           *
      ...
      var _ComplexResultsComponent = /*#__PURE__*/function () {
        ...
        _createClass(ComplexResultsComponent, [{
          ...
          value: function requestComplexResults() {
            var _this3 = this;
            this.complexPortalService.findComplex(this.query, this.filters.species, this.filters.bioRole, this.filters.interactorType, this.filters.predicted, this.filters.stars, this.currentPageIndex, this.pageSize).subscribe(function (complexSearch) {
          ...
          key: "onStarsFilterChanged",
          value: function onStarsFilterChanged(filter) {
