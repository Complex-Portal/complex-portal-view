...
const routes = [
    ...
    {
        path: 'basket',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_basket_basket_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! app/basket/basket.module */ 55801)).then(m => m.BasketModule)
    },
    {
        path: 'about',
