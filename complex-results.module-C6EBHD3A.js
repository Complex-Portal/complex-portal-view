import{a as z}from"./chunk-EEOXR4FL.js";import{a as u,b as d,c as B,d as j,e as V}from"./chunk-67UQAW4Z.js";import{a as M}from"./chunk-GSYOC2ZK.js";import{a as U}from"./chunk-42VQRCE7.js";import{m as N,o as E}from"./chunk-AATH6DNX.js";import{D,b,f as h,h as L}from"./chunk-4IDIV6ZM.js";import"./chunk-MMIKY225.js";import{Aa as c,Ab as T,Ba as m,Bb as A,Cb as k,Ea as F,ea as g,h as r,nb as O,xb as w,ya as p}from"./chunk-B7GOVUBZ.js";var G=`<div class="margin-top-large margin-bottom-large row expanded">
...
`;var fe=function(s,e,t,n){var o=arguments.length,i=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(s,e,t,n);else for(var l=s.length-1;l>=0;l--)(a=s[l])&&(i=(o<3?a(i):o>3?a(e,t,i):a(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i},Z="already_rated",R,I=(R=class{constructor(e){r(this,"analyticsService");r(this,"selectedRating");r(this,"hidden",!1);this.analyticsService=e}ngOnInit(){this.hidden=localStorage.getItem(Z)==="true"||!1}selectRating(e){this.selectedRating=e,this.analyticsService.rateComplexNavigator(this.selectedRating),localStorage.setItem(Z,"true"),setTimeout(()=>this.hidden=!0,2e3)}},r(R,"ctorParameters",()=>[{type:h}]),R);I=fe([p({selector:"cp-complex-navigator-rating",template:J,styles:[K]})],I);var ue=function(s,e,t,n){var o=arguments.length,i=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(s,e,t,n);else for(var l=s.length-1;l>=0;l--)(a=s[l])&&(i=(o<3?a(i):o>3?a(e,t,i):a(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i},ee=class{};ee=ue([F({imports:[k.forChild([{path:"",component:f}]),O,D,M,V,U,z],exports:[],declarations:[f,P,y,v,I]})],ee);export{ee as ComplexResultsModule};
//# sourceMappingURL=complex-results.module-C6EBHD3A.js.map
