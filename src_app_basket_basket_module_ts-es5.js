(function () {
  ...
  (self["webpackChunkcomplex_portal_view"] = self["webpackChunkcomplex_portal_view"] || []).push([["src_app_basket_basket_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */
      var _complex_complex_results_complex_navigator_complex_list_display_buttons_complex_list_display_buttons_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__( /*! ../complex/complex-results/complex-navigator/complex-list-display-buttons/complex-list-display-buttons.component */99915);
      ...
      var _BasketComponent = /*#__PURE__*/function () {
        ...
        _createClass(BasketComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.route.fragment.subscribe(function (fragment) {
              if (fragment === _complex_complex_results_complex_navigator_complex_list_display_buttons_complex_list_display_buttons_component__WEBPACK_IMPORTED_MODULE_6__.COMPLEX_NAVIGATOR_VIEW) {
                _this.DisplayType = _complex_complex_results_complex_navigator_complex_list_display_buttons_complex_list_display_buttons_component__WEBPACK_IMPORTED_MODULE_6__.COMPLEX_NAVIGATOR_VIEW;
              } else {
                _this.DisplayType = _complex_complex_results_complex_navigator_complex_list_display_buttons_complex_list_display_buttons_component__WEBPACK_IMPORTED_MODULE_6__.LIST_VIEW;
              }
            });
          }
        }, {
          ...
          value: function requestComplexesForNavigator() {
            ...
            this.complexPortalService.findComplex(this.createQuery(this._complexBasket), [], [], [], 1, pageSize).subscribe(function (complexSearch) {
                  ...
                  try {
                    var _loop = function _loop() {
                      ...
                      if (!_this2.allInteractorsInComplexSearchBasket.some(function (interactor) {
                        ...
                        _this2.allInteractorsInComplexSearchBasket.push(new _complex_shared_model_complex_results_interactor_model__WEBPACK_IMPORTED_MODULE_5__.Interactor(component.identifier, component.identifierLink, component.name, component.description, component.interactorType, component.organismName));
                      }
                    };
      ...
      _BasketComponent = __decorate([(0, _angular_core__WEBPACK_IMPORTED_MODULE_9__.Component)({
        selector: 'cp-basket',
    ...
    /***/
    function _(module) {
      module.exports = "/*.ComplexNavigator {*/\n/*  float: left;*/\n/*}*/\n.smallCN {\n  width: 100%;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */";
